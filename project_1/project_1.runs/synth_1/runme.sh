...
HD_PWD='/home/binhkieudo/Workspace/PhDThesis/_RoCC_TextSearch/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log matmul64.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source matmul64.tcl
